 ...
 * #checkNotNull(Object)} or Verify#verifyNotNull(Object) is appropriate to the situation. (The same
 ...
 * <a href="http://code.google.com/p/guava-libraries/wiki/PreconditionsExplained">using
