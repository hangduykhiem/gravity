 ...
 *
 * <p>See the Guava User Guide on <a href="http://code.google.com/p/guava-libraries/wiki/PreconditionsExplained">using
...
public final class Preconditions {
     ...
     *                             first {@code %s} gets {@code errorMessageArgs[0]}, etc.
