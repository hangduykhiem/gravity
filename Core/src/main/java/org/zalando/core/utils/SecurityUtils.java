...
public class SecurityUtils {
   ...
   * @return {@link Pair} where the first item is the encrypted text and second is the needed key to
   * decrypt it
   * @throws GeneralSecurityException if AES is not implemented on this system
   * @throws UnsupportedEncodingException if UTF-8 is not supported in this system
   */
  ...
  private static class AesCbcWithIntegrity {
     ...
     * @throws GeneralSecurityException if AES is not implemented on this system, or a suitable RNG
     * is not available
     */
  ...
  public static class MD5 {
     ...
     * are null; or either hash array is less than 16 bytes in length and their lengths and all of
